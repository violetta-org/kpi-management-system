...
# We will read the task log or write a script that queries the database, extracts data, and parses the XML.
# Let's write a python script to query and parse properly.
...
with open("scratch/parse_log_error.py", "w", encoding="utf-8") as f:
    f.write(code_to_run)
print("Created parse_log_error.py")
